...
// "C:\Program Files (x86)\Rockwell Software\FactoryTalk Activation\Tools\FTAManager.exe"
...
{
	WCHAR szFileName[MAX_PATH] = __T("C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe");
