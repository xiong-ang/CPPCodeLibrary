// VerifySignature.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	if (argc > 1)
	{
		...
		VerifyEmbeddedSignature(_T("C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe"));
